...
/*
  ...
  */
  ...
  implicit def JsArrayMonoid =
    new Monoid[JsArray] {
      def zero = JsArray(List.empty[JsValue])
...
/*
  ...
  */
  ...
  implicit def MapJsObjectMonoid =
    new Monoid[Map[JsString, JsObject]] {
  ...
  implicit def JsValueMonoid: Monoid[JsValue] =
    new Monoid[JsValue] {
      val zero = JsObject(Map.empty[JsString, JsValue])      
